...
//typedef enum {
#define    XQC_CONN_FLAG_WAIT_WAKEUP           ( 1ULL << XQC_CONN_FLAG_WAIT_WAKEUP_SHIFT)
#define    XQC_CONN_FLAG_HANDSHAKE_COMPLETED   ( 1ULL << XQC_CONN_FLAG_HANDSHAKE_COMPLETED_SHIFT)
#define    XQC_CONN_FLAG_CAN_SEND_1RTT         ( 1ULL << XQC_CONN_FLAG_CAN_SEND_1RTT_SHIFT)
#define    XQC_CONN_FLAG_TICKING               ( 1ULL << XQC_CONN_FLAG_TICKING_SHIFT)
#define    XQC_CONN_FLAG_ACK_HAS_GAP           ( 1ULL << XQC_CONN_FLAG_ACK_HAS_GAP_SHIFT)
#define    XQC_CONN_FLAG_TIME_OUT              ( 1ULL << XQC_CONN_FLAG_TIME_OUT_SHIFT)
#define    XQC_CONN_FLAG_ERROR                 ( 1ULL << XQC_CONN_FLAG_ERROR_SHIFT)
#define    XQC_CONN_FLAG_DATA_BLOCKED          ( 1ULL << XQC_CONN_FLAG_DATA_BLOCKED_SHIFT)
#define    XQC_CONN_FLAG_DCID_OK               ( 1ULL << XQC_CONN_FLAG_DCID_OK_SHIFT)
#define    XQC_CONN_FLAG_TOKEN_OK              ( 1ULL << XQC_CONN_FLAG_TOKEN_OK_SHIFT)
#define    XQC_CONN_FLAG_HAS_0RTT              ( 1ULL << XQC_CONN_FLAG_HAS_0RTT_SHIFT)
#define    XQC_CONN_FLAG_0RTT_OK               ( 1ULL << XQC_CONN_FLAG_0RTT_OK_SHIFT)
#define    XQC_CONN_FLAG_0RTT_REJ              ( 1ULL << XQC_CONN_FLAG_0RTT_REJ_SHIFT)
#define    XQC_CONN_FLAG_UPPER_CONN_EXIST      ( 1ULL << XQC_CONN_FLAG_UPPER_CONN_EXIST_SHIFT)
#define    XQC_CONN_FLAG_INIT_RECVD            ( 1ULL << XQC_CONN_FLAG_INIT_RECVD_SHIFT)
#define    XQC_CONN_FLAG_NEED_RUN              ( 1ULL << XQC_CONN_FLAG_NEED_RUN_SHIFT)
#define    XQC_CONN_FLAG_PING                  ( 1ULL << XQC_CONN_FLAG_PING_SHIFT)
#define    XQC_CONN_FLAG_HSK_ACKED             ( 1ULL << XQC_CONN_FLAG_HSK_ACKED_SHIFT)
#define    XQC_CONN_FLAG_RESERVE               ( 1ULL << XQC_CONN_FLAG_RESERVE_SHIFT)
#define    XQC_CONN_FLAG_HANDSHAKE_DONE_RECVD  ( 1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_RECVD_SHIFT)
#define    XQC_CONN_FLAG_UPDATE_NEW_TOKEN      ( 1ULL << XQC_CONN_FLAG_UPDATE_NEW_TOKEN_SHIFT)
#define    XQC_CONN_FLAG_VERSION_NEGOTIATION   ( 1ULL << XQC_CONN_FLAG_VERSION_NEGOTIATION_SHIFT)
#define    XQC_CONN_FLAG_HANDSHAKE_CONFIRMED   ( 1ULL << XQC_CONN_FLAG_HANDSHAKE_CONFIRMED_SHIFT)
#define    XQC_CONN_FLAG_HANDSHAKE_DONE_ACKED  ( 1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_ACKED_SHIFT)
#define    XQC_CONN_FLAG_ADDR_VALIDATED        ( 1ULL << XQC_CONN_FLAG_ADDR_VALIDATED_SHIFT)
#define    XQC_CONN_FLAG_LINGER_CLOSING        ( 1ULL << XQC_CONN_FLAG_LINGER_CLOSING_SHIFT)
#define    XQC_CONN_FLAG_RETRY_RECVD           ( 1ULL << XQC_CONN_FLAG_RETRY_RECVD_SHIFT)
#define    XQC_CONN_FLAG_TLS_CH_RECVD          ( 1ULL << XQC_CONN_FLAG_TLS_CH_SHIFT)
#define    XQC_CONN_FLAG_TLS_HSK_COMPLETED     ( 1ULL << XQC_CONN_FLAG_TLS_HSK_COMPLETED_SHIFT)
#define    XQC_CONN_FLAG_RECV_NEW_PATH         ( 1ULL << XQC_CONN_FLAG_RECV_NEW_PATH_SHIFT)
#define    XQC_CONN_FLAG_VALIDATE_REBINDING    ( 1ULL << XQC_CONN_FLAG_VALIDATE_REBINDING_SHIFT)
#define    XQC_CONN_FLAG_CLOSING_NOTIFY        ( 1ULL << XQC_CONN_FLAG_CONN_CLOSING_NOTIFY_SHIFT)
#define    XQC_CONN_FLAG_CLOSING_NOTIFIED      ( 1ULL << XQC_CONN_FLAG_CONN_CLOSING_NOTIFIED_SHIFT)
#define    XQC_CONN_FLAG_DGRAM_WAIT_FOR_1RTT   ( 1ULL << XQC_CONN_FLAG_DGRAM_WAIT_FOR_1RTT_SHIFT)
#define    XQC_CONN_FLAG_LOCAL_TP_UPDATED      ( 1ULL << XQC_CONN_FLAG_LOCAL_TP_UPDATED_SHIFT)
#define    XQC_CONN_FLAG_PMTUD_PROBING         ( 1ULL << XQC_CONN_FLAG_PMTUD_PROBING_SHIFT)
#define    XQC_CONN_FLAG_NO_DGRAM_NOTIFIED     ( 1ULL << XQC_CONN_FLAG_NO_DGRAM_NOTIFIED_SHIFT)
#define    XQC_CONN_FLAG_DGRAM_MSS_NOTIFY      ( 1ULL << XQC_CONN_FLAG_DGRAM_MSS_NOTIFY_SHIFT)
#define    XQC_CONN_FLAG_MP_WAIT_MP_READY      ( 1ULL << XQC_CONN_FLAG_MP_WAIT_MP_READY_SHIFT)
#define    XQC_CONN_FLAG_MP_READY_NOTIFY       ( 1ULL << XQC_CONN_FLAG_MP_READY_NOTIFY_SHIFT)
#define    XQC_CONN_FLAG_HANDSHAKE_DONE_SENT   ( 1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_SENT_SHIFT)
